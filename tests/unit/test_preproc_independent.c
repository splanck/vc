...
int main(void)
{
    ...
    char *r1 = preproc_run(&c1, tmpl1, &dirs, NULL, NULL, NULL, NULL, false, false); ASSERT(r1);
    char *r2 = preproc_run(&c2, tmpl2, &dirs, NULL, NULL, NULL, NULL, false, false); ASSERT(r2);
